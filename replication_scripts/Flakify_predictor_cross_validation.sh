...
model_weights="${replication_results_path}/REPLICATED_model_weights_${dataset}_dataset.pt"
results_file="${replication_results_path}/REPLICATED_results_${dataset}_dataset.csv"
